...
define Device/arcadyan_arv7519rw22
  ...
  KERNEL_SIZE := 2048k
  IMAGE_SIZE := 31232k
  DEVICE_PACKAGES := kmod-usb-dwc2 xrx200-phy22f-rev1.1-firmware xrx200-phy22f-rev1.2-firmware
...
define Device/arcadyan_vgv7510kw22-brn
  ...
  DEVICE_PACKAGES := kmod-rt2800-pci wpad-basic-mbedtls kmod-usb-dwc2 kmod-ltq-tapi \
	kmod-ltq-vmmc xrx200-rev1.1-phy22f-firmware xrx200-phy22f-rev1.2-firmware
...
define Device/avm_fritz3490
  ...
  DEVICE_PACKAGES := kmod-usb3 fritz-tffs xrx200-rev1.1-phy11g-firmware \
	xrx200-rev1.1-phy11g-firmware -kmod-owl-loader
endef
...
define Device/avm_fritz5490
  ...
  DEVICE_PACKAGES := kmod-dsa-qca8k kmod-phy-qca83xx kmod-usb3 fritz-tffs \
	xrx200-phy11g-firmware -ltq-vdsl-vr9-vectoring-fw-installer \
	-kmod-ltq-vdsl-vr9-mei -kmod-ltq-vdsl-vr9 -kmod-ltq-atm-vr9 \
	-kmod-ltq-ptm-vr9 -ltq-vdsl-vr9-app -kmod-owl-loader \
...
define Device/avm_fritz7490
  ...
  KERNEL_SIZE := 4096k
  IMAGE_SIZE := 49152k
  DEVICE_PACKAGES := kmod-usb3 fritz-tffs xrx200-phy11g-firmware -kmod-owl-loader
endef
